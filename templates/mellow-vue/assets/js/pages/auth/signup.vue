...
<template>
  ...
  >
    ...
    >
      ...
      >
        <InputText v-model="form.fullName" :error="form.errors.fullName" />
        <InputEmail v-model="form.email" :error="form.errors.email" />
        <InputPassword v-model="form.password" :error="form.errors.password" />
