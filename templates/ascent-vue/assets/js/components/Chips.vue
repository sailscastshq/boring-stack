...
<template>
  <div :class="['chips-container', props.class]">
    <div
      class="flex flex-wrap items-center gap-2 rounded-md border border-surface-300 bg-surface-0 p-2 focus-within:border-primary-500 focus-within:ring-1 focus-within:ring-primary-500 dark:border-surface-600 dark:bg-surface-900"
    >
      ...
      <Chip
        ...
        class="bg-primary-100 text-primary-800 dark:bg-primary-900/20 dark:text-primary-400"
      />
