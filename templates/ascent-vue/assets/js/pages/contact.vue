      ...
      <section class="mx-auto mt-16 max-w-xl">
        <div class="relative">
          ...
          >
              ...
              >
                <div>
                  ...
                  <InputText
                    id="name"
                    v-model="form.name"
                    class="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-4 text-lg font-medium transition-all duration-200 focus:border-brand-300 focus:bg-white focus:ring-4 focus:ring-brand-100"
            ...
            <footer class="mt-8 border-t border-gray-200 pt-8">
