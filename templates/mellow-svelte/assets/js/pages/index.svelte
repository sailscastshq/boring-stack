...
<svelte:head>
  <title>Simplify Authentication, Focus on Shipping | Mellow</title>
</svelte:head>
...
<section class="px-4 py-12 md:mx-auto md:w-10/12 md:px-8 md:py-16">
  <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
    <a
      ...
      class="group from-brand-50/10 block rounded-lg bg-gradient-to-b to-white p-6 shadow-md transition-all duration-300 hover:shadow-lg"
    >
    ...
    <a
      ...
      class="group from-brand-50/10 block rounded-lg bg-gradient-to-b to-white p-6 shadow-md transition-all duration-300 hover:shadow-lg"
    >
      <h3 class="text-brand mb-2 text-xl font-semibold">Sailscasts Discord</h3>
      <p class="mb-4 text-gray-600">
        Join the community to discuss Sails.js and get help. Connect with fellow
        developers and stay updated.
      </p>
      <button
        class="border-brand text-brand group-hover:bg-brand mt-2 rounded-lg border px-4 py-2 transition-colors duration-300 group-hover:text-white"
      >
    ...
    <a
      ...
      class="group from-brand-50/10 block rounded-lg bg-gradient-to-b to-white p-6 shadow-md transition-all duration-300 hover:shadow-lg"
    >
      <h3 class="text-brand mb-2 text-xl font-semibold">Star on GitHub ⭐️</h3>
      <p class="mb-4 text-gray-600">
